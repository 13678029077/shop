...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios(){
        ...
        $scenarios[self::SCENARIO_REG] = ['username','password1','password_hash','email','status'];//注册
        $scenarios[self::SCENARIO_LOGIN] = ['username','password_m','code','rememberme'];//登录
        $scenarios[self::SCENARIO_EDIT] = ['password','password1','password2','email','username','status'];//修改
        return $scenarios;
    }
