...
<head>
    ...
    <style type="text/css">
        .wo_page{padding-left:600px;}
        .wo_page li{
            border:2px;solid blue;float:left;margin-left:5px;
        }
    </style>
</head>
<body>
...
<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="index.html"><?=Html::img(Yii::getAlias('@web/images/logo.png') )?></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="http://www.shop.com/user/user.html">用户信息></a></li>
                            <li><a href="http://www.shop.com/goods/order.html">我的订单></a></li>
                            <li><a href="http://www.shop.com/goods/address.html">收货地址></a></li>
                            <li><a href="">我的收藏></a></li>
                        </ul>
                    ...
                    <div class="viewlist mt10">
                        <h3>最近浏览的商品：</h3>
                        <ul>
                            <li><a href=""><?=Html::img(Yii::getAlias('@web/images/view_list1.jpg') )?></a></li>
                            <li><a href=""><?=Html::img(Yii::getAlias('@web/images/view_list2.jpg') )?></a></li>
                            <li><a href=""><?=Html::img(Yii::getAlias('@web/images/view_list3.jpg') )?></a></li>
                        </ul>
                    </div>
                </dd>
            </dl>
