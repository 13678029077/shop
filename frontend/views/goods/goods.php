        ...
        <div class="related_view newgoods leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/relate_view2.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/relate_view3.jpg'))?></a></dt>
                    ...
                    <li>
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/relate_view4.jpg'))?></a></dt>
                    ...
                    <li class="last">
                        <dl>
                            <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/relate_view5.jpg'))?></a></dt>
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            foreach ($goods_pic as $pic):?>
                                <li <?=$count==0?'class="cur"':'';?>>
                                    <a <?=$count==0?'class="zoomThumbActive"':'';?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo 'http://admin.shop.com'.$goods_pic[$count]['img'] ?>',largeimage: '<?php echo 'http://admin.shop.com'.$goods_pic[$count]['img'] ?>'}">
                                        <?=\yii\helpers\Html::img(Yii::getAlias('http://admin.shop.com'.$goods_pic[$count]['img']),['style'=>'width:55px;height:50px','class'=>'goods_pic'])?>
                                    </a>
                                </li>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc1.jpg'))?>

                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc2.jpg'))?>

                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc3.jpg'))?>

                        <p style="height:10px;"></p>

                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc4.jpg'))?>

                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc5.jpg'))?>

                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc6.jpg'))?>

                        <p style="height:10px;"></p>

                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc7.jpg'))?>

                        <p style="height:10px;"></p>

                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc8.jpg'))?>

                        <p style="height:10px;"></p>
                        <?=\yii\helpers\Html::img(Yii::getAlias('@web/images/desc9.jpg'))?>
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/user1.gif'))?></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/user2.jpg'))?></a></dt>
                                <dd><a href="">小宝贝</a></dd>
                            </dl>
                        </div>
                        <div class="item">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img(Yii::getAlias('@web/images/user3.jpg'))?></a></dt>
                                <dd><a href="">天使</a></dd>
                            </dl>
                        </div>
                        <div class="item">
